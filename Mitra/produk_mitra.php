          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card p-2 shadow">
                ...
                <div class="row justify-content-between align-items-center">
                  <div class="col-auto">
                    <div class="item-label mb-2">
                      <h4> <i class="fa fa-dropbox fa-2x box-icon" aria-hidden="true"> </i> <b> Produk Saya</b></h4>
                    </div>
                  </div>
                  <!--//col-->
                </div>
              ...
              <div class="table-responsive p-0">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-drk fw-bold mb-0">Jenis Bensin 1</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <!-- <p class="text-xs font-weight-bold mb-0">3/Gasal</p> -->
                        <p class="text-xs text-dark mb-0">Pertamax</p>
                      </td>
                    </tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-dark fw-bold mb-0">Jumlah Bensin 1 (Liter)</p>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-dark fw-bold mb-0">Jenis Bensin 2</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs text-dark pr-20px mb-0">Pertalite</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-dark fw-bold mb-0">Jumlah Bensin 2 (Liter)</p>
                          </div>
                        </div>
                      </td>
                      <td>
                ...
                <br><br>
                <a href="update_produk_mitra.php">
                  <center>
                    <button type="submit" class="btn btn-simpan mb-1">Update Produk</button>
                  </center>
                </a>
              </div>
            </div>
