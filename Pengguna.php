...
//   $nama = $_POST["nama"];
//   $targetDocument = $pengguna->getDocumentId("nama", $nama);
//   $delete = $pengguna->deleteDocument($targetDocument);
//   if ($delete) {
...
<head>
  ...
  <title>Dibensinan | Pengguna</title>
    ...
    <div class="slider" id="sliders">
      ...
      <div class="slider-body px-1">
        <nav class="nav flex-column">
          ...
          <a class="nav-link active px-3" href="pengguna.php">
              ...
              <div class="card p-2 shadow">
                ...
                <form action="" method="post">
                    ...
                    <div class="row justify-content-between align-items-center">
                      <div class="col-auto">
                        <div class="item-label mb-2">
                          <h4> <i class="fa fa-user fa-2x box-icon" aria-hidden="true"> </i> <b>
                              <?php
                              print($value['nama']);
                              ?>
                            </b></h4>
                      ...
                      <div class="col text-end">
                        <button class="btn btn-selengkapnya mb-0">
                          <a href="hapusPengguna.php?nama=<?= $value["nama"]; ?>" onclick="return confirm('Hapus permanen data ini?');">
                            Hapus</a>
                        </button>
                      </div>
                    </div>
                  ...
                  <div class="item border-bottom border-top py-2">
                    <div class="row justify-content-between align-items-center">
                      <div class="col-auto">
                        <div class="item-label mb-0"><strong>Nomor Handphone</strong></div>
                      </div>
                      <!--//col-->
                      <div class="col text-end">
                  ...
                  <div class="item border-bottom py-2">
                    <div class="row justify-content-between align-items-center">
                      <div class="col-auto">
                        <div class="item-label mb-2"><strong>Alamat</strong></div>
                      </div>
                      <!--//col-->
                      <div class="col text-end">
                        <p class="item-label mb-0">
