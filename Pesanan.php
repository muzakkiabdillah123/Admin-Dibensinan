        ...
        <div class="slider" id="sliders">
            ...
            <div class="slider-body px-1">
                <nav class="nav flex-column">
                    ...
                    <hr class="soft my-1 bg-white">
                    <a class="nav-link active px-3" href="pesanan.php">
            ...
            <div class="container-fluid">
                <div class="row g-3 mb-3">
                    ...
                    foreach ($data as $key => $value) :
                        // $documentId = $pesanan->getAllDocumentId();
                        // $i = 0;
                        // $j = count($documentId);
                        // for ($i; $i < $j; $i++) :
                    ?>
                            ...
                            <div class="card p-2 shadow">
                                <form action="" method="post">
                                    ...
                                    <div class="item border-bottom border-top py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label mb-0"><strong>Tanggal Pemesanan</strong></div>
                                            </div>
                                            <!--//col-->
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label mb-2"><strong>Nama User</strong></div>
                                            </div>
                                            <!--//col-->
                                            <div class="col text-end">
                                                <p class="item-label mb-0"><?php
                                    ...
                                    <div class="item border-bottom py-2">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                <div class="item-label mb-2"><strong>Total Pembayaran</strong></div>
                                            </div>
                                            <!--//col-->
                                            <div class="col text-end">
                                                <p class="item-label mb-0">
